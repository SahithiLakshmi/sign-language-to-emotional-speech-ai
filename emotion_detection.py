...
class EmotionDetector:
    def __init__(self, model_path="models/emotion_model.onnx"):
        ...
        self.emotion_bias = {
            'neutral': 3.5,    # High bias for neutral to prevent jumping
            'happiness': 1.2,  # Boost happiness slightly
            'sadness': 0.4,    # Suppress sadness to avoid false "sad" detections
            'anger': 0.6,      # Suppress anger slightly
            'disgust': 0.8,
            'fear': 0.8,
            'surprise': 1.0
        }
    ...
    def predict_emotion(self, face_image):
        ...
        try:
            ...
            if probabilities[self.emotion_labels.index('neutral')] > 0.15:
